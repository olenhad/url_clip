...
class AccessesControllerTest < ActionController::TestCase
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post :create, access: { access_time: @access.access_time, ip_addr: @access.ip_addr, url_id: @access.url_id }
    end
  ...
  test "should update access" do
    patch :update, id: @access, access: { access_time: @access.access_time, ip_addr: @access.ip_addr, url_id: @access.url_id }
    assert_redirected_to access_path(assigns(:access))
  end
